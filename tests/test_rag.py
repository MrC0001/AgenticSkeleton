...
def test_rag_lookup_two_matches_found():
    ...
    assert MOCK_RAG_DB_FOR_TEST["topic1"]["context"] in result.rag_context, "Context from topic1 expected"
    assert MOCK_RAG_DB_FOR_TEST["topic2"]["context"] in result.rag_context, "Context from topic2 expected"
...
def test_rag_lookup_three_matches_found():
    ...
    assert MOCK_RAG_DB_FOR_TEST["topic1"]["context"] in result.rag_context, "Context from topic1 expected"
    assert MOCK_RAG_DB_FOR_TEST["topic2"]["context"] in result.rag_context, "Context from topic2 expected"
    assert MOCK_RAG_DB_FOR_TEST["topic3"]["context"] in result.rag_context, "Context from topic3 expected"
...
def test_rag_lookup_four_matches_found():
    ...
    assert MOCK_RAG_DB_FOR_TEST["topic2"]["context"] in result.rag_context, "Context from topic2 expected"
    assert MOCK_RAG_DB_FOR_TEST["topic3"]["context"] in result.rag_context, "Context from topic3 expected"
    assert MOCK_RAG_DB_FOR_TEST["topic4"]["context"] in result.rag_context, "Context from topic4 expected"
